...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    // Privacy Policy
    privacy_last_updated: "최종 수정일",
    privacy_section1_title: "1. 개인정보의 수집 및 이용 목적",
    privacy_section1_intro:
      "본 앱은 서비스 제공을 위해 필요한 최소한의 개인정보를 수집합니다. 수집된 정보는 다음의 목적으로만 사용됩니다.",
    privacy_purpose1: "서비스 제공 및 개선",
    privacy_purpose2: "이용자 지원 및 문의 응대",
    privacy_purpose3: "서비스 관련 공지사항 전달",
    privacy_section2_title: "2. 수집하는 개인정보 항목",
    privacy_collected1: "이메일 주소 (선택사항)",
    privacy_collected2: "기타 서비스 이용 과정에서 자동 생성되거나 제공되는 정보",
    privacy_section3_title: "3. 개인정보의 보유 및 이용 기간",
    privacy_storage_desc:
      "이용자의 개인정보는 서비스 제공 기간 동안 보유하며, 이용자의 요청에 따라 즉시 삭제됩니다. 다만, 관련 법령에 따라 일정 기간 보존해야 하는 정보는 해당 기간 동안 보존됩니다.",
    privacy_supabase_desc: "본 앱은 Supabase를 이용하며, Supabase의 개인정보 처리 방침에 따라 안전하게 관리됩니다.",
    privacy_section4_title: "4. 개인정보의 제3자 제공",
    privacy_retention_desc:
      "이용자의 개인정보는 원칙적으로 제3자에게 제공되지 않습니다. 다만, 법령에 특별한 규정이 있거나 법적으로 요구되는 경우에는 예외로 합니다.",
    privacy_section5_title: "5. 이용자의 권리",
    privacy_right1: "개인정보 열람 및 수정",
    privacy_right2: "개인정보 처리 정지 및 삭제 요청",
    privacy_right3: "개인정보 제공 동의 철회",
    privacy_section6_title: "6. 개인정보 보호를 위한 노력",

    // Terms of Service
    terms_last_updated: "최종 수정일",
    terms_section1_title: "1. 적용 범위",
    terms_section1_desc: "본 이용약관은 '기록의 숲' 앱에서 제공하는 모든 서비스에 적용됩니다.",
    terms_section2_title: "2. 서비스 이용 자격",
    terms_section2_desc: "본 서비스를 이용하려면 만 14세 이상이어야 합니다.",
    terms_section3_title: "3. 이용자의 의무",
    terms_service1: "정확한 정보 제공",
    terms_service2: "타인의 권리 침해 금지",
    terms_service3: "불법적인 활동 금지",
    terms_service4: "서비스 오용 및 악용 금지",
    terms_service5: "개인정보 보호 의무",
    terms_section4_title: "4. 서비스 제공자의 의무",
    terms_obligation1: "안정적인 서비스 제공",
    terms_obligation2: "개인정보 보호",
    terms_obligation3: "이용자 문의 응대",
    terms_section5_title: "5. 면책 조항",
    terms_section5_desc: "천재지변, 불가항력적인 사유로 인한 서비스 장애에 대해 회사는 책임을 지지 않습니다.",
    terms_section6_title: "6. 분쟁 해결",
    terms_section6_desc: "본 약관과 관련하여 분쟁이 발생한 경우, 대한민국 법률에 따라 해결합니다.",

    danger_zone: "위험 구역",
    delete_account: "계정 삭제",
    delete_account_title: "계정을 삭제하시겠습니까?",
    account_deletion_warning: "계정을 삭제하면 모든 데이터가 영구적으로 삭제됩니다. 이 작업은 취소할 수 없습니다.",
    delete_account_warning_title: "경고: 계정 삭제는 되돌릴 수 없습니다",
    delete_warning_1: "모든 기록(노트, 일기, 일정 등)이 영구적으로 삭제됩니다",
    delete_warning_2: "데이터를 복구할 수 없습니다",
    delete_warning_3: "계속하시려면 아래에 '계정 삭제'를 입력하세요",
    delete_account_confirm_instruction: "삭제하시려면 아래에 정확히 입력하세요:",
    delete_account_confirm_phrase: "계정 삭제",
    ...
    announcement_message_placeholder: "공지 내용을 입력하세요",
    ...
    data_management_description: "귀하의 개인정보를 자유롭게 열람하고 관리할 수 있습니다.",
    view: "보기",
    hide: "숨기기",
    view_data: "데이터 열람",
    data_export_description: "위 백업/복원 섹션에서 데이터를 다운로드할 수 있습니다.",
    fill_all_fields: "모든 필드를 입력해주세요",
    email_updated_success: "이메일이 업데이트되었습니다",
    email_update_error: "이메일 업데이트 실패",
  },
  ...
  en: {
    ...
    privacy_section1_title: "1. Purpose of Collection and Use of Personal Information",
    privacy_section1_intro:
      "This app collects the minimum necessary personal information to provide services. Collected information is used only for the following purposes.",
    privacy_purpose1: "Service Provision and Improvement",
    privacy_purpose2: "User Support and Inquiry Response",
    privacy_purpose3: "Delivery of Service-Related Announcements",
    privacy_section2_title: "2. Items of Personal Information Collected",
    privacy_collected1: "Email address (optional)",
    privacy_collected2: "Other information automatically generated or provided during service use",
    privacy_section3_title: "3. Retention and Use Period of Personal Information",
    privacy_storage_desc:
      "User's personal information is retained for the duration of service provision and is deleted immediately upon user request. However, information that must be retained for a certain period according to relevant laws will be retained for that period.",
    privacy_supabase_desc: "This app uses Supabase and is securely managed according to Supabase's privacy policy.",
    privacy_section4_title: "4. Provision of Personal Information to Third Parties",
    privacy_retention_desc:
      "User's personal information is not provided to third parties in principle. However, exceptions may apply if there are special provisions in laws or if legally required.",
    privacy_section5_title: "5. User Rights",
    privacy_right1: "Access and Correction of Personal Information",
    privacy_right2: "Request for Suspension of Processing and Deletion of Personal Information",
    privacy_right3: "Withdrawal of Consent for Provision of Personal Information",
    privacy_section6_title: "6. Efforts to Protect Personal Information",

    // Terms of Service
    terms_last_updated: "Last Updated",
    terms_section1_title: "1. Scope of Application",
    terms_section1_desc: "These Terms of Service apply to all services provided by the 'Forest Note' app.",
    terms_section2_title: "2. Service Eligibility",
    terms_section2_desc: "You must be 14 years of age or older to use this service.",
    terms_section3_title: "3. User Obligations",
    terms_service1: "Provision of Accurate Information",
    terms_service2: "Prohibition of Infringement of Others' Rights",
    terms_service3: "Prohibition of Illegal Activities",
    terms_service4: "Prohibition of Misuse and Abuse of Services",
    terms_service5: "Obligation to Protect Personal Information",
    terms_section4_title: "4. Provider's Obligations",
    terms_obligation1: "Stable Service Provision",
    terms_obligation2: "Protection of Personal Information",
    terms_obligation3: "Response to User Inquiries",
    terms_section5_title: "5. Disclaimer",
    terms_section5_desc:
      "The company is not responsible for service disruptions due to natural disasters or force majeure events.",
    terms_section6_title: "6. Dispute Resolution",
    terms_section6_desc:
      "Any disputes arising in connection with these terms shall be resolved in accordance with the laws of the Republic of Korea.",
    ...
    delete_account_warning_title: "Warning: Account deletion is irreversible",
    delete_warning_1: "All your records (notes, diaries, schedules, etc.) will be permanently deleted",
    delete_warning_2: "Your data cannot be recovered",
    delete_warning_3: "To proceed, type 'Delete Account' below",
    delete_account_confirm_instruction: "To confirm deletion, type exactly below:",
    delete_account_confirm_phrase: "Delete Account",
    ...
    announcement_message_placeholder: "Enter announcement message",
    ...
    data_management_description: "You can view and manage your personal information freely.",
    view: "View",
    hide: "Hide",
    view_data: "View Data",
    data_export_description: "You can download your data from the Backup/Restore section above.",
  ...
  zh: {
    ...
    // Legal Information
    terms_section6_title: "6. 争议解决",
    terms_section6_desc: "因本条款引起的任何争议，均按照大韩民国法律解决。",

    danger_zone: "危险区域",
    delete_account: "删除账户",
    delete_account_title: "您确定要删除您的账户吗？",
    account_deletion_warning: "删除账户将永久删除您的所有数据。此操作无法撤销。",
    delete_account_warning_title: "警告：账户删除无法恢复",
    delete_warning_1: "您的所有记录（笔记、日记、日程等）将被永久删除",
    delete_warning_2: "您的数据将无法恢复",
    delete_warning_3: "继续操作，请在下方输入“删除账户”",
    delete_account_confirm_instruction: "为确认删除，请在下方准确输入：",
    delete_account_confirm_phrase: "删除账户",
    delete_account_phrase_mismatch: "您输入的短语不匹配",
    account_deleted_success: "您的账户已成功删除",
    account_deletion_failed: "删除账户失败",
    deleting: "删除中...",
    ...
    announcement_message_placeholder: "请输入公告消息",
    ...
    data_management_description: "您可以自由查看和管理您的个人信息。",
    view: "查看",
    hide: "隐藏",
    view_data: "查看数据",
    data_export_description: "您可以在上方的备份/恢复部分下载您的数据。",
    fill_all_fields: "请填写所有字段",
    email_updated_success: "邮箱已成功更新",
  ...
  ja: {
    ...
    // Legal Information
    terms_section6_title: "6. 紛争解決",
    terms_section6_desc: "本規約に関連する紛争は、大韓民国法に従って解決されます。",

    danger_zone: "危険区域",
    delete_account: "アカウント削除",
    delete_account_title: "アカウントを削除しますか？",
    account_deletion_warning: "アカウントを削除すると、すべてのデータが永久に削除されます。この操作は取り消せません。",
    delete_account_warning_title: "警告：アカウント削除は取り消せません",
    delete_warning_1: "すべてのアカウント情報（ノート、日記、スケジュールなど）が永久に削除されます",
    delete_warning_2: "データを復元することはできません",
    delete_warning_3: "続行するには、以下に「アカウント削除」と入力してください",
    delete_account_confirm_instruction: "削除を確定するには、以下を正確に入力してください：",
    delete_account_confirm_phrase: "アカウント削除",
    ...
    announcement_message_placeholder: "お知らせメッセージを入力",
    ...
    data_management_description: "個人情報を自由に閲覧・管理できます。",
    view: "表示",
    hide: "非表示",
    view_data: "データ閲覧",
    data_export_description: "上記のバックアップ/復元セクションからデータをダウンロードできます。",
    fill_all_fields: "すべてのフィールドを入力してください",
    email_updated_success: "メールアドレスが更新されました",
