...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    diary_too_short_for_analysis: "일기 내용이 너무 짧습니다 (최소 20자)",
  ...
  en: {
    ...
    diary_too_short_for_analysis: "Diary content is too short (minimum 20 characters)",
  ...
  zh: {
    ...
    diary_too_short_for_analysis: "日记内容太短（至少20个字符）",
  ...
  ja: {
    ...
    diary_too_short_for_analysis: "日記の内容が短すぎます（最低20文字）",
