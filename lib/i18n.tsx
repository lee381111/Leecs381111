...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    app_introduction_description: "일정, 건강, 예산 관리 등 생활 전반을 기록하고 관리하는 올인원 앱입니다.",
    notes_description: "메모와 회의록을 작성하고 AI로 정리하거나 요약할 수 있습니다.",
    diaries: "일기",
    diaries_description: "일상을 기록하고 비밀번호로 보호할 수 있습니다.",
    schedules: "일정",
    schedules_description: "특별한 날과 일반 일정을 관리하고 알람을 설정할 수 있습니다.",
    travel_records: "여행 기록",
    travel_records_description: "여행지를 지도에 기록하고 AI로 일정을 최적화할 수 있습니다.",
    vehicle_records: "차량 기록",
    vehicle_records_description: "차량 정보와 정비 기록을 관리할 수 있습니다.",
    health_records: "건강 기록",
    health_records_description: "혈압, 혈당, 체중 등을 기록하고 복약 일정을 관리할 수 있습니다.",
    budget_description: "수입과 지출을 기록하고 AI가 예산을 분석해드립니다.",
    business_cards_description: "명함을 촬영하여 OCR로 자동 입력하고 관리할 수 있습니다.",
    weather_description: "현재 날씨와 주간 예보를 확인할 수 있습니다.",
    radio_description: "국내 및 해외 라디오 방송을 실시간으로 들을 수 있습니다.",
    data_backup: "데이터 백업",
    data_backup_description: "모든 데이터를 안전하게 백업하고 복원할 수 있습니다.",

    customer_support: "고객 지원",
    customer_support_description: "문의사항이 있으시면 아래 이메일로 연락해주세요.",
    support_email: "이메일: lee381111@gmail.com",
    ...
    data_management_description: "내 데이터 열람 및 관리",
    view_data: "데이터 보기",
    data_export_description: "위 백업/복원 섹션을 사용하여 모든 데이터를 다운로드할 수 있습니다.",
    ...
    delete_account_title: "계정 영구 삭제",
    account_deletion_warning: "계정과 모든 데이터가 영구적으로 삭제됩니다.",
    delete_account_warning_title: "경고",
    delete_warning_1: "모든 노트, 일정, 건강 기록 등이 삭제됩니다",
    delete_warning_2: "삭제된 데이터는 복구할 수 없습니다",
    delete_warning_3: "계정 삭제 후 다시 가입해야 합니다",
    delete_account_confirm_instruction: "계속하려면 아래에 '영구 삭제'를 입력하세요:",
    delete_account_confirm_phrase: "영구 삭제",
    delete_account_phrase_mismatch: "입력이 일치하지 않습니다",
    account_deleted_success: "계정이 삭제되었습니다",
    account_deletion_failed: "계정 삭제 실패",
    deleting: "삭제 중...",
    ...
    announcement_message_placeholder: "사용자에게 표시할 메시지를 입력하세요",
    ...
    // Settings Section Additions (English)
    app_developer: "App Developer",
    developer_info: "Chanse Lee, Janggi-dong, Gimpo-si",
    app_introduction: "App Introduction",
    app_introduction_description:
      "An all-in-one app for recording and managing your entire life, including schedules, health, and budget.",
    notes_description: "Write notes and meeting minutes, and organize or summarize them with AI.",
    diaries: "Diary",
    diaries_description: "Record your daily life and protect it with a password.",
    schedules: "Schedules",
    schedules_description: "Manage special days and general schedules, and set alarms.",
    travel_records: "Travel Records",
    travel_records_description: "Record your travel destinations on a map and optimize itineraries with AI.",
    vehicle_records: "Vehicle Records",
    vehicle_records_description: "Manage vehicle information and maintenance records.",
    health_records: "Health Records",
    health_records_description: "Record blood pressure, blood sugar, weight, etc., and manage medication schedules.",
    budget_description: "Record income and expenses, and let AI analyze your budget.",
    business_cards_description: "Scan business cards for OCR auto-input and management.",
    weather_description: "Check current weather and weekly forecasts.",
    radio_description: "Listen to domestic and international radio broadcasts in real-time.",
    data_backup: "Data Backup",
    data_backup_description: "Securely back up and restore all your data.",

    customer_support: "Customer Support",
    customer_support_description: "If you have any inquiries, please contact us via the email below.",
    support_email: "Email: lee381111@gmail.com",
    ...
    data_management_description: "View and manage your data",
    view_data: "View Data",
    data_export_description: "You can download all your data using the Backup/Restore section above.",
    ...
    account_deletion_warning: "Your account and all associated data will be permanently deleted.",
    delete_account_warning_title: "Warning",
    delete_warning_1: "All notes, schedules, health records, etc., will be deleted.",
    delete_warning_2: "Deleted data cannot be recovered.",
    delete_warning_3: "You will need to re-register after account deletion.",
    delete_account_confirm_instruction: "Type 'Delete Permanently' below to confirm:",
    delete_account_confirm_phrase: "Delete Permanently",
    delete_account_phrase_mismatch: "Input does not match",
