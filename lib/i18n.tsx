...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    consent_history: "약관 동의 이력",
    consent_history_description: "이용약관 및 개인정보처리방침 동의 기록입니다.",
  ...
  en: {
    ...
    consent_history_description: "Record of your terms and privacy policy agreements.",
    no_consent_logs: "No consent records found",
    agreed_on: "Agreed on",
    terms_agreed: "Terms of Service",
    privacy_agreed: "Privacy Policy",
  },
  ...
  zh: {
    ...
    consent_history: "同意历史记录",
    consent_history_description: "您的服务条款和隐私政策同意记录。",
  ...
  ja: {
    ...
    consent_history_description: "利用規約およびプライバシーポリシーの同意記録です。",
    no_consent_logs: "同意記録がありません",
    agreed_on: "同意日時",
    terms_agreed: "利用規約",
    privacy_agreed: "プライバシーポリシー",
  },
}
