...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    voice_input_active: "语音识别中...请说出您的待办事项",
    voice_input_stopped: "语音识别已停止",
    filter_all: "全部",
    filter_active: "进行中",
  ...
  en: {
    ...
    voice_input_active: "Voice recognition active... Please speak your to-do",
  ...
  ja: {
    ...
    voice_input_active: "音声認識中...やることを話してください",
    voice_input_stopped: "音声認識停止",
    filter_all: "すべて",
    filter_active: "進行中",
    filter_completed: "完了",
    todo_stats: "統計",
