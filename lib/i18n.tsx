...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    privacy_sensitive_warning: "⚠️ 본 앱은 사용자의 민감한 개인정보 저장을 권장하지 않습니다",
    terms_disclaimer_title: "면책 조항",
    terms_disclaimer1: "서비스 장애, 기기 변경 등으로 인한 데이터 손실에 대해서는 개발자는 책임을 지지 않습니다",
    ...
    <p>- 이메일 주소 (계정 생성 시)</p>
    <p>- 사용자가 자발적으로 입력한 데이터 (노트, 일정, 건강 기록 등)</p>
    
    <h4 class="font-semibold mt-4 mb-2 text-red-600">⚠️ 중요 안내</h4>
    <p class="text-red-600 font-medium">본 앱은 사용자의 민감한 개인정보 저장을 권장하지 않습니다.</p>
    <p>주민등록번호, 여권번호, 금융정보 등의 민감정보는 저장하지 마시기 바랍니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. 개인정보의 이용 목적</h4>
    <p>- 서비스 제공 및 개선</p>
    <p>- 사용자 인증 및 계정 관리</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. 개인정보 보유 및 이용 기간</h4>
    <p>- 회원 탈퇴 시까지 또는 서비스 종료 시까지</p>
    <p>- 탈퇴 후 즉시 삭제 (법령에 따라 보존이 필요한 경우 제외)</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. 개인정보의 제3자 제공</h4>
    <p>기록의숲은 사용자의 개인정보를 제3자에게 제공하지 않습니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. 사용자의 권리</h4>
    <p>- 개인정보 열람, 수정, 삭제 요청</p>
    <p>- 계정 삭제 (설정 > 위험 영역)</p>
  `,
    terms_of_service_content: `
    <h3 class="font-bold text-lg mb-2">이용약관</h3>
    <p class="mb-4">기록의숲 서비스 이용에 관한 약관입니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. 서비스 이용</h4>
    <p>- 본 서비스는 개인 기록 관리를 위한 도구를 제공합니다.</p>
    <p>- 사용자는 관련 법령을 준수하여 서비스를 이용해야 합니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. 면책 사항</h4>
    <p class="font-medium">- 서비스 장애, 기기 변경 등으로 인한 데이터 손실에 대해서는 개발자는 책임을 지지 않습니다.</p>
    <p class="font-medium">- 본 서비스의 AI 기능은 참고용 정보이며 전문적인 조언을 대체하지 않습니다.</p>
    <p class="font-medium">- 사용자가 저장한 콘텐츠에 대한 책임은 사용자에게 있습니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. 서비스 변경 및 중단</h4>
    <p>- 개발자는 서비스를 변경하거나 중단할 수 있으며, 사전 공지합니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. 계정 관리</h4>
    <p>- 사용자는 자신의 계정을 안전하게 관리할 책임이 있습니다.</p>
    <p>- 부적절한 사용이 발견될 경우 계정이 제한될 수 있습니다.</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. 약관 변경</h4>
    <p>- 본 약관은 필요에 따라 변경될 수 있으며, 변경 시 공지합니다.</p>
  `,
  },
  ...
  en: {
    ...
    privacy_sensitive_warning: "⚠️ This app does not recommend storing sensitive personal information",
    terms_disclaimer_title: "Disclaimer",
    terms_disclaimer1: "The developer is not responsible for data loss due to service failures, device changes, etc.",
    terms_disclaimer2: "The AI features of this service are for reference only and do not replace professional advice",
    terms_disclaimer3: "Users are responsible for the content they store",
    privacy_policy_content: `
    <h3 class="font-bold text-lg mb-2">Privacy Policy</h3>
    <p class="mb-4">Record Forest values your privacy and processes personal information as follows.</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. Personal Information Collected</h4>
    <p>- Email address (for account creation)</p>
    <p>- Data voluntarily entered by users (notes, schedules, health records, etc.)</p>
    
    <h4 class="font-semibold mt-4 mb-2 text-red-600">⚠️ Important Notice</h4>
    <p class="text-red-600 font-medium">This app does not recommend storing sensitive personal information.</p>
    <p>Please do not store sensitive data such as social security numbers, passport numbers, or financial information.</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. Purpose of Use</h4>
    <p>- Providing and improving services</p>
    <p>- User authentication and account management</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. Retention Period</h4>
    <p>- Until account deletion or service termination</p>
    <p>- Deleted immediately upon withdrawal (except as required by law)</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. Third-Party Sharing</h4>
    <p>Record Forest does not share your personal information with third parties.</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. Your Rights</h4>
    <p>- Request to view, modify, or delete personal information (Settings > Personal Information Management)</p>
    <p>- Delete account (Settings > Danger Zone)</p>
  `,
    terms_of_service_content: `
    <h3 class="font-bold text-lg mb-2">Terms of Service</h3>
    <p class="mb-4">Terms and conditions for using Record Forest service.</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. Service Use</h4>
    <p>- This service provides tools for personal record management.</p>
    <p>- Users must comply with relevant laws when using the service.</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. Disclaimer</h4>
    <p class="font-medium">- The developer is not responsible for data loss due to service failures, device changes, etc.</p>
    <p class="font-medium">- The AI features of this service are for reference only and do not replace professional advice.</p>
    <p class="font-medium">- Users are responsible for the content they store.</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. Service Changes and Interruptions</h4>
    <p>- The developer may change or discontinue the service with prior notice.</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. Account Management</h4>
    <p>- Users are responsible for keeping their accounts secure.</p>
    <p>- Accounts may be restricted if inappropriate use is detected.</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. Changes to Terms</h4>
    <p>- These terms may be changed as necessary, with notification of changes.</p>
  `,
  },
  ...
  zh: {
    ...
    register: "注册",
    update: "更新",
    vehicle_name_and_plate_required: "车辆名称和车牌号是必需的",
    ...
    announcement_update: "新功能已添加。快来看看吧！",
    ...
    privacy_sensitive_warning: "⚠️ 本应用不建议存储敏感个人信息",
    terms_disclaimer_title: "免责声明",
    terms_disclaimer1: "服务故障、设备更换等导致的数据丢失，开发者不承担责任",
    terms_disclaimer2: "本服务的AI功能仅供参考，不能替代专业建议",
    terms_disclaimer3: "用户对其存储的内容负责",
    privacy_policy_content: `
    <h3 class="font-bold text-lg mb-2">隐私政策</h3>
    <p class="mb-4">记录森林重视您的隐私，按以下方式处理个人信息。</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. 收集的个人信息</h4>
    <p>- 电子邮件地址（创建账户时）</p>
    <p>- 用户自愿输入的数据（笔记、日程、健康记录等）</p>
    
    <h4 class="font-semibold mt-4 mb-2 text-red-600">⚠️ 重要提示</h4>
    <p class="text-red-600 font-medium">本应用不建议存储敏感的个人信息。</p>
    <p>请勿存储身份证号、护照号、金融信息等敏感数据。</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. 使用目的</h4>
    <p>- 提供和改进服务</p>
    <p>- 用户认证和账户管理</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. 保留期限</h4>
    <p>- 直到账户删除或服务终止</p>
    <p>- 注销后立即删除（法律要求保留的除外）</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. 第三方共享</h4>
    <p>记录森林不会与第三方共享您的个人信息。</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. 您的权利</h4>
    <p>- 请求查看、修改或删除个人信息（设置 > 个人信息管理）</p>
    <p>- 删除账户（设置 > 危险区域）</p>
  `,
    terms_of_service_content: `
    <h3 class="font-bold text-lg mb-2">服务条款</h3>
    <p class="mb-4">记录森林服务使用条款和条件。</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. 服务使用</h4>
    <p>- 本服务提供个人记录管理工具。</p>
    <p>- 用户在使用服务时必须遵守相关法律。</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. 免责声明</h4>
    <p class="font-medium">- 开发者不对因服务故障、设备更换等原因导致的数据丢失负责。</p>
    <p class="font-medium">- 本服务的AI功能仅供参考，不能替代专业建议。</p>
    <p class="font-medium">- 用户对其存储的内容负责。</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. 服务变更和中断</h4>
    <p>- 开发者可能会变更或中断服务，并提前通知。</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. 账户管理</h4>
    <p>- 用户有责任确保其账户安全。</p>
    <p>- 如发现不当使用，账户可能会被限制。</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. 条款变更</h4>
    <p>- 这些条款可能会根据需要进行变更，变更时会通知。</p>
  `,
  },
  ...
  ja: {
    ...
    privacy_sensitive_warning: "⚠️ 本アプリは機密性の高い個人情報の保存を推奨していません",
    terms_disclaimer_title: "免責事項",
    terms_disclaimer1: "サービス障害、デバイス変更などによるデータ損失については、開発者は責任を負いません",
    terms_disclaimer2: "本サービスのAI機能は参考情報であり、専門的なアドバイスに代わるものではありません",
    terms_disclaimer3: "ユーザーは保存したコンテンツに対して責任を負います",
    privacy_policy_content: `
    <h3 class="font-bold text-lg mb-2">プライバシーポリシー</h3>
    <p class="mb-4">記録の森は、お客様のプライバシーを大切にし、以下のように個人情報を処理します。</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. 収集する個人情報</h4>
    <p>- メールアドレス（アカウント作成時）</p>
    <p>- ユーザーが自発的に入力したデータ（メモ、スケジュール、健康記録など）</p>
    
    <h4 class="font-semibold mt-4 mb-2 text-red-600">⚠️ 重要なお知らせ</h4>
    <p class="text-red-600 font-medium">本アプリは、機密性の高い個人情報の保存を推奨していません。</p>
    <p>マイナンバー、パスポート番号、金融情報などの機密データは保存しないでください。</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. 利用目的</h4>
    <p>- サービスの提供と改善</p>
    <p>- ユーザー認証とアカウント管理</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. 保存期間</h4>
    <p>- アカウント削除またはサービス終了まで</p>
    <p>- 退会後は即座に削除（法律で保存が必要な場合を除く）</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. 第三者への提供</h4>
    <p>記録の森は、お客様の個人情報を第三者に提供しません。</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. お客様の権利</h4>
    <p>- 個人情報の閲覧・修正（設定 > 個人情報管理）</p>
    <p>- アカウント削除（設定 > 危険区域）</p>
  `,
    terms_of_service_content: `
    <h3 class="font-bold text-lg mb-2">利用規約</h3>
    <p class="mb-4">記録の森サービスの利用に関する規約です。</p>
    
    <h4 class="font-semibold mt-4 mb-2">1. サービスの利用</h4>
    <p>- 本サービスは個人記録管理のためのツールを提供します。</p>
    <p>- ユーザーはサービスを利用する際、関連法令を遵守する必要があります。</p>
    
    <h4 class="font-semibold mt-4 mb-2">2. 免責事項</h4>
    <p class="font-medium">- サービス障害、機器変更などによるデータ損失について、開発者は責任を負いません。</p>
    <p class="font-medium">- 本サービスのAI機能は参考情報であり、専門的なアドバイスの代わりではありません。</p>
    <p class="font-medium">- ユーザーは保存したコンテンツに対して責任を負います。</p>
    
    <h4 class="font-semibold mt-4 mb-2">3. サービスの変更と中断</h4>
    <p>- 開発者はサービスを変更または中断することができ、事前に通知します。</p>
    
    <h4 class="font-semibold mt-4 mb-2">4. アカウント管理</h4>
    <p>- ユーザーは自分のアカウントを安全に管理する責任があります。</p>
    <p>- 不適切な使用が発見された場合、アカウントが制限されることがあります。</p>
    
    <h4 class="font-semibold mt-4 mb-2">5. 規約の変更</h4>
    <p>- 本規約は必要に応じて変更される場合があり、変更時に通知されます。</p>
  `,
  },
}
