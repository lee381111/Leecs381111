...
type TranslationKey =
  ...
  | "csv_format"
  | "excel_format"
  | "korean_message_required"
  | "announcement_created"
  | "announcement_updated"
  | "announcement_save_failed"
  | "storage_remaining"
  | "upgrade_premium"
  | "pi_free_user_storage_info"
  | "pi_premium_user_storage_info"
...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    expires: "만료",
    korean_message_required: "한국어 메시지는 필수입니다",
    saving: "저장 중...",
    announcement_created: "공지사항이 생성되었습니다",
    announcement_updated: "공지사항이 수정되었습니다",
    announcement_save_failed: "공지사항 저장에 실패했습니다",
    ...
    pi_free_user_storage_info: "Pi 무료 사용자는 100MB를 사용할 수 있습니다.",
    pi_premium_user_storage_info: "Pi 프리미엄 사용자는 500MB를 사용할 수 있습니다.",
  ...
  en: {
    ...
    expires: "Expires",
    korean_message_required: "Korean message is required",
    saving: "Saving...",
    ...
    pi_free_user_storage_info: "Pi free users get 100MB storage.",
    pi_premium_user_storage_info: "Pi premium users get 500MB storage.",
  ...
  zh: {
    ...
    expires: "到期",
    korean_message_required: "韩语消息为必填项",
    saving: "保存中...",
    announcement_created: "公告创建成功",
    announcement_updated: "公告修改成功",
    announcement_save_failed: "保存公告失败",
    delete_failed: "删除失败",
    ...
    pi_free_user_storage_info: "Pi免费用户可使用100MB存储空间。",
    pi_premium_user_storage_info: "Pi高级用户可使用500MB存储空间。",
  ...
  ja: {
    ...
    expires: "有効期限",
    korean_message_required: "韓国語メッセージは必須です",
    saving: "保存中...",
    announcement_created: "お知らせが作成されました",
    announcement_updated: "お知らせが変更されました",
    announcement_save_failed: "お知らせの保存に失敗しました",
    ...
    pi_free_user_storage_info: "Pi無料ユーザーは100MBのストレージを使用できます。",
    pi_premium_user_storage_info: "Piプレミアムユーザーは500MBのストレージを使用できます。",
