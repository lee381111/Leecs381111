...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ...
  en: {
    ...
    tos_7_content:
      "The company is exempt from responsibility for service provision in cases where service cannot be provided due to force majeure events such as natural disasters, strikes, or enactment/amendment of relevant laws. ...",
    ...
    pp_3_title: "Article 3 (Period of Retention and Use of Personal Information)",
    pp_3_content:
  ...
  ja: {
    ...
    // Vehicle Section Translations
    add_vehicle: "車両追加",
    first_vehicle: "最初の車両登録",
    vehicle_list: "車両リスト",
    new_vehicle: "新規車両",
    edit_vehicle: "車両編集",
    vehicle_name_placeholder: "車両名（例：私のセダン）",
    ...
    no_vehicles: "登録されている車両がありません",
    records_count: "整備記録",
    schedules_count: "整備スケジュール",
    records_unit: "件",
    tap_to_add_maintenance_and_schedule: "タップして整備記録・スケジュールを追加",
    ...
    used_lowercase: "使用済み",
    remaining: "残り",
    storage_full: "ストレージ容量がほぼ満杯です！ファイルを削除するか、プレミアムにアップグレードしてください。",
    ...
    upgrade_for_1_pi: "月額1Piでアップグレード",
    upgrade_coming_soon: "プレミアムアップグレード機能は近日公開予定です！",
    email_user_storage_info: "メールユーザーは500MBを無料で利用できます",
    admin_storage_info: "管理者アカウントは1GBのストレージを利用できます",
    ...
    vehicle_name: "車両名",
    vehicle_name_placeholder: "例：私のカローラ",
    license_plate: "車両番号",
    license_plate_placeholder: "例：品川 300 あ 12-34",
    vehicle_type: "車種",
    car: "乗用車",
    motorcycle: "バイク",
    bicycle: "自転車",
    ...
    add_station: "放送局追加",
    no_stations_message: "登録された放送局はありません。",
    play: "再生",
    stop: "停止",
    of: "/",
    upgrade_storage: "ストレージアップグレード",
    free_plan: "無料プラン",
    storage_full_warning: "ストレージ容量がいっぱいです。不要なファイルを削除するか、アップグレードしてください。",
    no_location_permission: "位置情報へのアクセス権限がありません。",
    getting_location: "現在地情報を取得中...",
    update: "更新",
    height: "身長",
    ...
    no_consent_logs: "同意ログが見つかりません",
    tos_title: "利用規約",
    tos_effective_date: "施行日",
    tos_last_updated: "最終更新日",
    tos_acceptance: "利用規約への同意",
    tos_acceptance_content: "上記利用規約に同意します。",
    tos_1_title: "第1条（目的）",
    tos_1_content: "本規約は...",
    tos_2_title: "第2条（定義）",
    tos_2_content: "本規約において使用する用語の定義は次のとおりです。...",
    tos_3_title: "第3条（利用契約）",
    tos_3_content: "利用契約は、利用者が本規約の内容に同意の意思を表示することにより成立します。...",
    tos_4_title: "第4条（利用者の義務）",
    tos_4_content: "利用者は、次の各号の行為をしてはなりません。...",
    tos_5_title: "第5条（サービス提供および中断）",
    tos_5_content: "当社は、利用者に安定したサービスを提供します。...",
    tos_6_title: "第6条（個人情報の保護）",
    tos_6_content: "当社は、個人情報保護法等関連法令を遵守します。...",
    tos_7_title: "第7条（免責事項）",
    tos_7_content:
      "当社は、天災地変、ストライキ、関連法令の制定・改廃等、不可抗力的な事由によりサービスを提供できない場合、サービス提供に関する責任を免除されます。...",
    pp_title: "プライバシーポリシー",
    pp_effective_date: "施行日",
    pp_last_updated: "最終更新日",
    pp_intro: "本プライバシーポリシーは...",
    pp_1_title: "第1条（収集する個人情報の項目および収集方法）",
    pp_1_content:
      "当社は、利用契約の履行、サービス提供、利用者識別、サービス改善のために、以下の個人情報を収集します。...",
    pp_2_title: "第2条（個人情報の収集および利用目的）",
    pp_2_content: "当社は、収集した個人情報を次の目的のためにのみ利用します。...",
    pp_3_title: "第3条（個人情報の保有および利用期間）",
    pp_3_content:
      "当社は、法令による個人情報の保有・利用期間、または情報主体から個人情報を収集時に同意を得た個人情報の保有・利用期間内で個人情報を保有・利用します。...",
    pp_4_title: "第4条（個人情報の第三者提供）",
    pp_4_content: "当社は、利用者の個人情報を原則として第三者に提供しません。...",
    pp_5_title: "第5条（個人情報の破棄）",
    pp_5_content:
      "当社は、個人情報の保有期間の経過、処理目的の達成等、当該個人情報が不必要になった際には、遅滞なく当該個人情報を破棄します。...",
    pp_6_title: "第6条（利用者および法定代理人の権利とその行使方法）",
  ...
  zh: {
    ...
    "1_week_before": "1周前",
    add_schedule: "添加日程",
    download_ics_description: "下载为ICS文件，添加到手机日历",
    title_label: "标题",
    category_label: "类别",
    ...
    new_vehicle: "新车辆",
    edit_vehicle: "编辑车辆",
    vehicle_name_placeholder: "车辆名称（例如：我的朗逸）",
    license_plate_placeholder: "车牌号",
    vehicle_type_placeholder: "车辆类型（例如：轿车、SUV）",
    vehicle_model_placeholder: "车型（例如：2023款）",
    purchase_year_placeholder: "购买年份（例如：2023）",
    insurance_placeholder: "保险公司（例如：中国平安）",
    vehicle_type: "车辆类型",
    vehicle_model: "车型",
    purchase_year: "购买年份",
    insurance: "保险",
    ...
    register: "注册",
    update: "更新",
    vehicle_name_and_plate_required: "车辆名称和车牌号是必填项",
    vehicle_saved: "车辆已成功保存",
    save_error: "保存车辆时出错",
    delete_vehicle_confirm: "确定要删除此车辆吗？",
    deleted: "已删除",
    delete_error: "删除车辆时出错",
    no_vehicles: "未注册车辆",
    records_count: "保养记录",
    ...
    mileage: "里程",
    km_unit: "公里",
    mileage_placeholder: "请输入里程",
    amount: "费用",
    won_unit: "元",
    amount_placeholder: "请输入费用",
    memo_placeholder: "请输入备注",
    save_maintenance: "保存保养记录",
    date_required: "日期是必填项",
    ...
    estimated_mileage_placeholder: "请输入预计里程",
    description: "描述",
    description_placeholder: "请输入保养描述",
    alarm_setting: "闹钟设置",
    ...
    save_schedule: "保存计划",
    scheduled_date_required: "计划日期是必填项",
    ...
    used_lowercase: "已用",
    remaining: "剩余",
    storage_full: "存储空间几乎满了！请删除文件或升级到高级版。",
    storage_warning: "存储使用量已超过80%。请释放空间。",
    premium: "高级版",
    ...
    // Announcement Translations
    announcement_welcome: "欢迎来到Pi生活管理器！",
    announcement_maintenance: "系统维护安排中。请留意服务使用。",
    announcement_update: "新功能已添加。快来看看吧！",
    announcement_event: "特别活动进行中！",

    // New Translations
    app_title: "记录之森",
    welcome_message: "欢迎来到记录之森！",
    logout: "退出登录",
    my_forest: "我的森林",
    note_title_placeholder: "输入标题",
    note_content_placeholder: "输入内容",
    no_notes_message: "添加笔记来记录！",
    event_title_placeholder: "事件标题",
    start_time: "开始时间",
    end_time: "结束时间",
    location: "地点",
    location_placeholder: "请输入地点",
    no_events_message: "无事件。添加一个日程！",
    search_location: "搜索地点",
    weather_loading: "加载天气中...",
    ...
    travel_destination_placeholder: "例如：北京、上海",
    no_travels_message: "无旅行记录。添加一次旅行！",
    vehicle_name: "车辆名称",
    vehicle_name_placeholder: "例如：我的凯美瑞",
    license_plate: "车牌号",
    license_plate_placeholder: "例如：京A 12345",
    vehicle_type: "车辆类型",
    car: "轿车",
    motorcycle: "摩托车",
    bicycle: "自行车",
    other: "其他",
    no_vehicles_message: "无车辆记录。注册车辆！",
    mileage_placeholder: "请输入里程",
    add_maintenance: "添加保养",
    cost_placeholder: "请输入费用",
    no_maintenance_records: "无保养记录。",
    diary_content_placeholder: "今天过得怎么样？",
    no_diary_entries: "无日记条目。写日记吧！",
    todo_title_placeholder: "输入待办事项",
    completed: "已完成",
    in_progress: "进行中",
    not_started: "未开始",
    radio_station_placeholder: "广播电台名称",
    radio_url_placeholder: "广播流URL",
    add_station: "添加电台",
    ...
    update: "更新",
    height: "身高",
    height_placeholder: "请输入身高（厘米）",
    weight: "体重",
    blood_pressure_placeholder: "例如：120/80",
    blood_sugar_placeholder: "例如：90",
    heart_rate: "心率",
    heart_rate_placeholder: "请输入心率",
    notes_optional: "备注（可选）",
    notes_placeholder: "请输入附加备注",
    record_date: "记录日期",
    no_health_records: "无健康记录。",
    health_metrics: "健康指标",
    medication_name_placeholder: "请输入药品名称",
    dosage_placeholder: "请输入剂量",
    frequency_placeholder: "请输入频率",
    ...
    agreed_at: "同意时间",
    user_agent: "用户代理",
    no_consent_logs: "无同意日志",
    tos_title: "服务条款",
    tos_effective_date: "生效日期",
    tos_last_updated: "最后更新日期",
    tos_acceptance: "服务条款接受",
    tos_acceptance_content: "我同意以上服务条款。",
    tos_1_title: "第1条（目的）",
    tos_1_content: "本条款旨在...",
    tos_2_title: "第2条（定义）",
    tos_2_content: "本条款中使用的术语定义如下。...",
    tos_3_title: "第3条（服务协议）",
    tos_3_content: "用户表示同意本条款内容即构成服务协议。...",
    tos_4_title: "第4条（用户义务）",
    tos_4_content: "用户不得进行以下行为。...",
    tos_5_title: "第5条（服务提供与中断）",
    tos_5_content: "公司向用户提供稳定的服务。...",
    tos_6_title: "第6条（个人信息保护）",
    tos_6_content: "公司遵守《个人信息保护法》等相关法律法规。...",
    tos_7_title: "第7条（免责声明）",
    tos_7_content:
      "因不可抗力（如自然灾害、罢工、相关法律的制定/修订等）导致公司无法提供服务时，公司对服务提供的责任免除。...",
    pp_title: "隐私政策",
    pp_effective_date: "生效日期",
    pp_last_updated: "最后更新日期",
    pp_intro: "本隐私政策...",
    pp_1_title: "第1条（收集的个人信息项目及收集方法）",
    pp_1_content: "公司为履行用户协议、提供服务、识别用户、改进服务等目的，收集以下个人信息。...",
    pp_2_title: "第2条（个人信息的收集和使用目的）",
    pp_2_content: "公司收集的个人信息仅用于以下目的。...",
    pp_3_title: "第3条（个人信息的保有及利用期间）",
    pp_3_content:
      "公司在法律规定的个人信息保有·利用期间，或在从信息主体收集个人信息时同意的个人信息保有·利用期间内，保有·利用个人信息。...",
    pp_4_title: "第4条（向第三方提供个人信息）",
    pp_4_content: "公司原则上不向第三方提供用户的个人信息。...",
    pp_5_title: "第5条（个人信息的销毁）",
    pp_5_content: "当个人信息的保有期间届满、处理目的达成等个人信息变得不必要时，公司将立即销毁该个人信息。...",
    pp_6_title: "第6条（用户及法定代理人的权利及其行使方法）",
