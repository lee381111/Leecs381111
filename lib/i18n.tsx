...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    todo_completed: "완료됨",
    todo_incomplete: "미완료",
    mark_as_completed: "완료 표시",
    mark_as_incomplete: "미완료 표시",
    no_todos_message: "할 일이 없습니다. 새로운 할 일을 추가해보세요!",
    voice_input_todo: "음성으로 추가",
    voice_input_active: "음성 인식 중... 할 일을 말씀해주세요",
    voice_input_stopped: "음성 인식 중지",
    filter_all: "전체",
    filter_active: "미완료",
    filter_completed: "완료",
    todo_stats: "통계",
  ...
  en: {
    ...
    no_todos_message: "No to-dos yet. Add one to get started!",
    voice_input_todo: "Voice Input",
    voice_input_active: "Listening... Speak your to-do",
  ...
  zh: {
    ...
    no_todos_message: "暂无待办事项。添加一个开始吧！",
    voice_input_todo: "语音输入",
    voice_input_active: "正在听... 请说出您的待办事项",
  ...
  ja: {
    ...
    no_todos_message: "やることがありません。追加してください！",
    voice_input_todo: "音声入力",
    voice_input_active: "聞いています...やることを話してください",
    voice_input_stopped: "音声入力停止",
    filter_all: "すべて",
    filter_active: "進行中",
    filter_completed: "完了",
    todo_stats: "統計",
